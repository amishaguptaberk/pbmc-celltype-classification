...
part1_figures = [
    ...
    ('figures/training_curve.png',
     'Figure 2. Autoencoder training curve. Train MSE ~0.79, validation MSE ~0.87 at early stopping. Dropout regularization reduces the gap from ~0.19 to ~0.09.'),
    ('figures/pca.png',
...
part1_writeup = (
    ...
    "subtle ways across many dimensions, tend to collapse onto each other in the first two PCs. "
...
part2_writeup = (
    ...
    "The top genes by feature importance include CD79A, GNLY, NKG7, and CD3D, which are known "
    "markers for B cells, NK/cytotoxic T cells, and T cells, alongside monocyte markers like "
    "LYZ and CST3. The model is picking up on real biological signal rather than noise."
)
